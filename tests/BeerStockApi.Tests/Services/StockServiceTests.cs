...
{
    private readonly Mock<IWholesalerBeerRepository> _mockWholesalerBeerRepository;
    private readonly Mock<IBeerRepository> _mockBeerRepository;
    private readonly Mock<IWholesalerRepository> _mockWholesalerRepository;
    private readonly Mock<ILogger<StockService>> _mockLogger;
    private readonly StockService _service;

    public StockServiceTests()
    {
        _mockWholesalerBeerRepository = new Mock<IWholesalerBeerRepository>();
        ...
        _service = new StockService(_mockWholesalerBeerRepository.Object, _mockBeerRepository.Object, _mockWholesalerRepository.Object, _mockLogger.Object);
    }
    ...
    public async Task GetStockAsync_ReturnsStock_WhenStockExists()
    {
        ...
        _mockWholesalerBeerRepository.Setup(r => r.GetStockAsync(wholesalerId, beerId))
            .ReturnsAsync(stock);
    ...
    {
        // Arrange
        _mockWholesalerBeerRepository.Setup(r => r.GetStockAsync(It.IsAny<int>(), It.IsAny<int>()))
    ...
    {
        // Arrange
        _mockWholesalerBeerRepository.Setup(r => r.GetByWholesalerIdAsync(It.IsAny<int>()))
            .ReturnsAsync([]);
    ...
    public async Task GetStocksByWholesalerAsync_ReturnsStocks_WhenStocksExist()
    {
        ...
        _mockWholesalerBeerRepository.Setup(r => r.GetByWholesalerIdAsync(wholesalerId))
            .ReturnsAsync(stocks);
    ...
    public async Task GetWholesalersForBeerAsync_ReturnsWholesalers_WhenBeerIsAvailable()
    {
        ...
        _mockWholesalerBeerRepository.Setup(r => r.GetByBeerIdAsync(beerId))
            .ReturnsAsync(stocks);
    ...
    public async Task UpdateStockAsync_UpdatesStock_WithValidQuantity()
    {
        ...
        _mockWholesalerBeerRepository.Setup(r => r.UpdateStockAsync(It.IsAny<WholesalerBeer>()))
        ...
        _mockWholesalerBeerRepository.Verify(r => r.UpdateStockAsync(It.IsAny<WholesalerBeer>()), Times.Once);
    }
